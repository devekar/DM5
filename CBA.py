...
def apriori_read_order_subsume( apriori_arg1, apriori_arg2, features_list, labels_list ):
    ...
    print ""
    apriori_command = ['./apriori', apriori_arg1, apriori_arg2, '-tr', APRIORI_INPUT_PATH , RULES_PATH ]
...
def main(argv):
    ...
    while len(uncovered_features_list) > 100 and len(uncovered_features_list)!= prev_len and iteration < TOTAL_ITERATIONS:
        ...
        apriori_read_order_subsume( apriori_arg1, apriori_arg2, uncovered_features_list, uncovered_labels_list )
